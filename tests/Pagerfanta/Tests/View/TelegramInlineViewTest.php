...
EOF
    ...
    public function testRenderWhenStartProximityIs2()
    {
        ...
        $this->assertRenderedView(<<<EOF
{"inline_keyboard":[[{"text":"1","callback_data":"|1|"},{"text":"2","callback_data":"|2|"},{"text":"3","callback_data":"|3|"},{"text":"· 4 ·","callback_data":"|4|"},{"text":"5","callback_data":"|5|"},{"text":"6 ›","callback_data":"|6|"},{"text":"100 »","callback_data":"|100|"}]]}
EOF
        , $this->renderView($options));
    }
    ...
    public function testRenderWhenStartProximityIs3()
    {
        ...
        $this->assertRenderedView(<<<EOF
{"inline_keyboard":[[{"text":"1","callback_data":"|1|"},{"text":"3","callback_data":"|3|"},{"text":"4","callback_data":"|4|"},{"text":"· 5 ·","callback_data":"|5|"},{"text":"6","callback_data":"|6|"},{"text":"7 ›","callback_data":"|7|"},{"text":"100 »","callback_data":"|100|"}]]}
EOF
        , $this->renderView($options));
    }
    ...
    public function testRenderWhenEndProximityIs2FromLast()
    {
        ...
        $this->assertRenderedView(<<<EOF
{"inline_keyboard":[[{"text":"« 1","callback_data":"|1|"},{"text":"‹ 94","callback_data":"|94|"},{"text":"95","callback_data":"|95|"},{"text":"96","callback_data":"|96|"},{"text":"· 97 ·","callback_data":"|97|"},{"text":"98","callback_data":"|98|"},{"text":"99 ›","callback_data":"|99|"},{"text":"100","callback_data":"|100|"}]]}
EOF
        , $this->renderView($options));
    }
    ...
    public function testRenderWhenEndProximityIs3FromLast()
    {
        ...
        $this->assertRenderedView(<<<EOF
{"inline_keyboard":[[{"text":"« 1","callback_data":"|1|"},{"text":"‹ 93","callback_data":"|93|"},{"text":"94","callback_data":"|94|"},{"text":"95","callback_data":"|95|"},{"text":"· 96 ·","callback_data":"|96|"},{"text":"97","callback_data":"|97|"},{"text":"98 ›","callback_data":"|98|"},{"text":"100","callback_data":"|100|"}]]}
EOF
        , $this->renderView($options));
    }
